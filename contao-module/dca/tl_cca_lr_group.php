...
$GLOBALS['TL_DCA']['tl_cca_lr_group'] = [

	'config' => [
		'dataContainer'		=> 'Table',
// 		'enableVersioning'	=> true,
		'onsubmit_callback'	=> [
			[ GroupDCA::class, 'onsubmitGroup' ],
		],
		'sql'				=> [
			'keys'				=> [
				'id'				=> 'primary',
	...
	'list' => [
		...
		'label' => [
			'fields'			=> [ 'title' ],
			'format'			=> '%s',
			'label_callback'	=> [ GroupDCA::class, 'labelGroup' ],
			'group_callback'	=> [ GroupDCA::class, 'groupGroup' ],
		],
		'global_operations' => [
		],
		'operations' => [
	...
	'fields' => [
		...
		'roots' => [
			...
			'load_callback' => [
				[ GroupDCA::class, 'loadRoots' ],
			],
			'save_callback' => [
				[ GroupDCA::class, 'saveRoots' ],
			],
		],
	],
